...
% A 4th order lowpass Butterworth filter with a cutoff frequency of 2000 Hz
fc = 2000; % Hz; This is a reasonable choice.
...
audiowrite('output_audio_file.wav', output, Fs);
